...
public class UnstablePowerTest {
	...
	public void TestUnstablePower() {
		...
		c3.add(c1);
		c3.add(c2);
		ReactionCard cra = new UnstablePower();
		cra.use(c3, g);
	...
	public void TestReact(){
		Game g = new Game(2);
		ReactionCard c = new UnstablePower();
	...
	public void TestCanReactTo(){
		ReactionCard c1 = new UnstablePower();
		Crash c2 = new UnstablePower();
	...
	@Test
	public void TestNewUnstablePowerWorks(){
		ReactionCard c = new UnstablePower();
		Card newC = c.newCard();
		assertEquals(newC.name, "UnstablePower");
	}
}
